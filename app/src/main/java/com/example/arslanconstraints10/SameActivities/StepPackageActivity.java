...
import com.example.arslanconstraints10.databinding.ActivityStepPackageBinding;

public class StepPackageActivity extends AppCompatActivity {
    TextView pk2;
    ActivityStepPackageBinding stBinding;
    Button btn_addShipStepPack;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        stBinding = ActivityStepPackageBinding.inflate(getLayoutInflater());
        setContentView(stBinding.getRoot());

        RecyclerView recyclerViewPkg = (RecyclerView) findViewById(R.id.recView_pkg);
